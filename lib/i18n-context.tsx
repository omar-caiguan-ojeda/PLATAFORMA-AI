...
const translations = {
  en: {
    ...
    "pricing.complete.medusa.price": "$4,500",
    ...
    "pricing.complete.totaldiscount": "Total $7,497 USD Discount ($903 USD)",
    ...
    "pricing.complete.addon.price": "From $5,500",
    ...
    "pricing.medusa.setup.price": "$4,500",
  ...
  es: {
    ...
    "pricing.complete.ecommy.price": "$3,900",
    "pricing.complete.totaldiscount": "Total $7,497 USD Descuento ($903 USD)",
    ...
    "pricing.complete.addon.price": "Desde $5,500",
