...
const translations = {
  en: {
    ...
    "pricing.complete.medusa.price": "$3,500",
    "pricing.complete.medusa.desc": "with default templates",
    "pricing.complete.ecommy": "eCommy AI Setup",
    "pricing.complete.ecommy.price": "$3,900",
    "pricing.complete.totaldiscount": "Total $6,497 USD Discount ($903 USD)",
    "pricing.complete.monthly": "Monthly Maintenance",
    "pricing.complete.monthly.price": "From $500/month",
    "pricing.complete.monthly.desc": "Maintenance for both platforms",
    "pricing.complete.addon": "Add-on: Custom Design",
    "pricing.complete.addon.price": "From $4,000",
    "pricing.complete.addon.desc": "Personalized Medusa JS design",
    "pricing.complete.extra": "Add feature like emailing, discount, checkout etc $500 each one",
  ...
  es: {
    ...
    "pricing.complete.ecommy.price": "$3,900",
    "pricing.complete.totaldiscount": "Total $6,497 USD Descuento ($903 USD)",
    "pricing.complete.monthly": "Fee Mensual",
    "pricing.complete.monthly.price": "Desde $500/mes",
    "pricing.complete.monthly.desc": "Mantenimiento de ambos",
    "pricing.complete.addon": "Add-on: Diseño Personalizado",
    "pricing.complete.addon.price": "Desde $4,000",
    "pricing.complete.addon.desc": "Diseño personalizado Medusa JS",
    "pricing.complete.extra": "Agregar feature como emailing, descuentos, checkout etc $500 cada una",
    ...
    "pricing.medusa.monthly.price": "$300/mes",
    ...
    "pricing.ecommy.monthly.price": "$400/mes",
